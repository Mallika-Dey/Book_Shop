    ...
    <div id="carouselExample" class="carousel slide" data-ride="carousel" data-interval="900000">
        <div class="carousel-inner row w-100 mx-auto" role="listbox">
            <div class="carousel-item col-12 col-sm-6 col-md-4 col-lg-2 active">
                ...
                <div>
                     <a href="cart/cart.php?id=<?php echo $pic[0][3];?> &userid=<?php echo $_SESSION['user']['userid'];?>" class="btn btn-success">Add To cart</a>
                </div>
           		</div>
        	</div>
            <?php
            for($i=1; $i<sizeof($pic); $i++)    {
                ...
                <div>
                    <a href="cart/cart.php?id='.$pic[$i][3].' &userid='.$_SESSION['user']['userid'].'" class="btn btn-success">Add To cart</a>
                </div>
                </div>
                </div>';
            }
