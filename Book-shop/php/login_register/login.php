...
<body>
	<form action="login.php" method="POST">
		<div class="field" id="field">
			...
			<input type="text" name="username" placeholder="Enter Your UserName" class="txtbox" id="username" required><br><br>

			<p id="boxname">Password:</p>
			<input type="password" name="pass" placeholder="Enter Password" class="txtbox" id="pass" required><br><br>
